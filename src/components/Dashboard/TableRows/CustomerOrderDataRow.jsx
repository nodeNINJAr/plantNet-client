...
// 
const {_id,plantImage,plantCategory,plantName,price,quantity,status , productId} = order || {} ;
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        ...
        <DeleteModal isOpen={isOpen} closeModal={closeModal} handleCancle={handleCancle} />
      </td>
    </tr>
  )
}
